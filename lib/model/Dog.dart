...
class Dog {
  ...
  Dog(this._id, this._name, this._size, this._lifespan, this._about, this._imageRef, this._health, this._grooming, this._nutrition, this._exercise, this._training,);
